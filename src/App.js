...
import {
  Ecommerce, Orders, Customers, Calendar, Employees, Stacked, Pyramid,
        ...
        <div className="flex relative dark:bg-main-dark-bg">
          <div className="fixed right-4 bottom-4 " style={{ zIndex: '1000' }}>
            <TooltipComponent content='Settings' position="Top">
              <button type='button' className='text-3xl hover:drop-shadow-xl hover:bg-light-gray p-3 text-white'
